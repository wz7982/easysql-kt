...
fun visitExpr(e: Expr<*>?): SqlExpr = when (e) {
    ...
    is Column -> SqlPropertyExpr((if (e.schema.aliasName_ == null) e.table else e.schema.aliasName_)!!, e.column)
    is PrimaryKey -> SqlPropertyExpr((if (e.schema.aliasName_ == null) e.table else e.schema.aliasName_)!!, e.column)
